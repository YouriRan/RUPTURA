...
class Components:
    ...
    def addComponent(
        ...
        cpp_isotherms = [
            _ruptura.Isotherm(isothermMeta[isotherm[0]]['typeid'],
                              isotherm[1:],
...
class MixturePrediction:
    ...
    def setComponentsParameters(self, molfracs: np.ndarray, params: np.ndarray):
        ...
        -----------
        params: np.ndarray
            The parameters to set for the components.
        """
    ...
    def getComponentsParameters(self):
        """
        Get the parameters of the components involved in the mixture.
...
class Breakthrough:
    ...
    def getComponentsParameters(self) -> np.ndarray:
        """
        Gets the component parameters for the breakthrough model.
        
        Returns:
            np.ndarray: A list of parameters for the components.
        """
        return np.array(self.Breakthrough.getComponentsParameters())
