...
PYBIND11_MODULE(_ruptura, m)
{
    ...
    py::class_<Breakthrough>(m, "Breakthrough")
        .def(py::init<std::string, std::vector<Component>, size_t, size_t, size_t, double, double, double, double, double, double, double, double, size_t, bool, bool, double, const MixturePrediction>())
